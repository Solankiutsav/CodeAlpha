...
question = {
	"1+8": ['2', '3', '5', '9'],
	"National bird of india": ['pegion', 'flamingo', 'peacock', 'crow'],
	"Prime minister of india":['Rishi Sunak', 'Narendra Modi', 'Georgia Miloni', 'Joe Biden']
}
# define answer list
ans = ['9', 'peacock', 'Narendra Modi']
...
def next_question():
	...
	if current_question < len(question):
		...
		Label(f1, text=output, font="Georgia").pack()
